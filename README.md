...
### Instalation
1. Download **base_pack.zip** from latest [release](https://github.com/qweruba/rehlds-server/releases/latest/).
...
- [ReHLDS](https://github.com/dreamstalker/rehlds/) ([3.10.0.761](https://github.com/dreamstalker/rehlds/releases/lastest/))
